...
<div>
    描述: <input type="text" name="story" id="story">
</div>
<div>
...
?>
    <tr>
        ...
        <td>
            <button onclick="location.href='./front/photo_update.php?id=<?=$img['id'];?>'">編輯</button>    
            <button onclick="location.href='./api/photo_delete.php?id=<?=$img['id'];?>'">刪除</button>    
        </td>
    </tr>
<?php
}
