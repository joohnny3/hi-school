    ...
    <body>
        <form action="./api/select_scores.php" method="post">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="max">
                <label class="form-check-label" for="inlineRadio1">班級最高分</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="min">
                <label class="form-check-label" for="inlineRadio2">班級最低分</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="pass">
                <label class="form-check-label" for="inlineRadio2">班級合格學生</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio3" value="flunk">
