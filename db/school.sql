...
CREATE TABLE `board` (
  ...
  `school_num` varchar(15) DEFAULT NULL
...
INSERT INTO `board` (`id`, `subject`, `time`, `content`, `school_num`) VALUES
(1, '測試感謝', '2023-06-17 09:29:04', '感謝大家的測試！\r\n也希望大家多多棒場。', '11250102'),
(2, '有下雨嗎？', '2023-06-17 10:35:00', '好煩喔', '11250103'),
(3, NULL, '2023-06-17 12:08:03', '在某些情況下，foreach 迴圈和 while 迴圈可以用來達到相似的目的，但在你提供的這段程式碼中，將 while 迴圈換成 foreach 迴圈可能不適合，原因在於這兩種迴圈的運作方式有所不同。\r\n\r\nwhile 迴圈在這裡用於持續從 $RecBoard 查詢結果集中取出每一行，直到 fetch_assoc() 回傳 NULL，表示已經沒有更多的資料行。\r\n\r\n另一方面，foreach 迴圈是用於遍歷陣列或物件的每一個元素。但是在這種情況下，查詢結果集 $RecBoard 並不是一個可遍歷的陣列或物件，而是一個結果集物件，你必須呼叫 fetch_assoc() 方法來取出每一行。因此，這裡不能直接使用 foreach 迴圈來替代 while 迴圈。', '11250101'),
(4, NULL, '2023-06-17 12:11:26', '對於線段序列中的每個線段，我們將其起點的 x 座標 b 和終點的 x 座標 e 提取出來。\r\n\r\n創建一個陣列 A，該陣列的索引表示 x 座標，陣列中的元素表示該 x 座標上的線段數量。\r\n\r\n當一個線段進入時，我們將 b 索引位置的元素加 1，表示該 x 座標上有一個新的線段開始。\r\n\r\n當一個線段結束時，我們將 e 索引位置的元素減 1，表示該 x 座標上有一個線段結束。\r\n\r\n遍歷陣列 A，從索引 1 開始到索引 N-1（N 是陣列的長度），將每個元素 A[i] 更新為 A[i] + A[i-1]，即將前面的元素值累加到當前位置，以獲得每個 x 座標上的線段數量。', '11250105'),
(5, NULL, '2023-06-17 13:18:21', 'figure 屬於 HTML5 的新型態標籤，拿來作為圖片並結合描述文字的獨立區塊。Bootstrap 對於這種圖片說明標籤用途有特別進行定義。fig 使用 figure 主標籤包覆，內部包一個 img 標籤做圖片來源與 figcaption 標籤\n<figure>\n\n', '11250102'),
(6, NULL, '2023-06-17 14:20:10', '在這個日新月異的現代社會中，我們經常忙於追趕工作、社交媒體和日常生活的快節奏。然而，我們是否有時會忽略了我們最初與自然世界之間的連結？今天，讓我們一起回到大自然，重新探索與環境的和諧關係，找回內心的平衡。', '11250102'),
(7, NULL, '2023-06-17 14:22:18', '進入大自然世界不僅可以為我們提供寧靜和放鬆的環境，還能帶來身心健康的好處。研究表明，與自然接觸可以降低壓力、減輕焦慮，甚至提升情緒和集中力。沉浸在大自然中，我們可以感受到微風的拂過、聆聽鳥鳴、欣賞花草樹木的美麗，這些都能夠幫助我們緩解現代生活所帶來的種種壓力。', '11250102'),
(8, NULL, '2023-06-17 14:24:01', '在這個現代快節奏的社會中，我們需要重新與自然建立聯繫，以實現身心的平衡和維護地球的生態平衡。通過回歸自然，我們可以重拾內心的寧靜，同時也為未來世代建立一個更美好的環境。讓我們共同努力，重新發現並珍惜與自然世界的連結，讓這個世界變得更加和諧與可持續。', '11250106');
...
(16, '11250304', NULL, NULL, NULL, NULL);
...
(64, '呂布', '11250304', '11250304', 'student', 'A123456789'),
(65, '呂捷', 'admin508', 'admin', 'teacher', 'A123456788'),
(67, '', 'lllllllll', '', 'teacher', '');
...
(11250101, '資訊工程', 70, 80, 90, 80, 50),
(11250102, '資訊工程', 40, 55, 65, 90, 88),
(11250103, '資訊工程', 78, 91, 93, 70, 65),
(11250104, '資訊工程', 90, 96, 69, 75, 84),
(11250105, '資訊工程', 40, 55, 95, 79, 68),
(11250106, '資訊工程', 66, 78, 66, 85, 58),
...
(11250304, '化工材料', NULL, NULL, NULL, NULL, NULL);
...
(18, 11250102, '李子柒', 'Liziqi', '1995/07/04', 'B199007062', '四川市綿陽區', '0919900706', 'theliziqiwoman@gmail.com', '資訊工程', '李佳佳', '李子柒（Li Ziqi）是一位知名的中國網絡紅人和內容創作者。她以在YouTube和其他社交媒體平台上分享自己生活在中國鄉村的日常生活而聞名，她以其精湛的技藝和寧靜美麗的影片風格而受到廣大觀眾的喜愛。  李子柒的真實身份是李雪（Li Xue），她於1995年出生在四川省的一個小村莊。在她年幼時，她的祖父母教會了她許多傳統的手工藝技巧和農耕技術，這些技能在她的影片中得到了展示。她通過展示中國傳統文化和生活方式的美麗，向觀眾展示了她的成長背景和她的家鄉。  李子柒的影片以其高品質的製作和細膩的攝影而聞名。她通常展示自己種植蔬菜、釀造酒、烹飪食物、縫製衣物和制作傳統工藝品等活動。她在影片中展示的技巧和細節使人們對中國傳統文化和農村生活產生了濃厚的興趣。  李子柒的影片在全球范圍內獲得了廣泛的關注和認可。她的YouTube頻道已經擁有數千萬的訂閱者，她的影片在社交媒體上被廣泛分享和轉載。她的作品也獲得了多個獎項和榮譽，並被譽為展示中國傳統文化的優秀代表之一。  李子柒的成功不僅在於她的影片本身，也在於她所代表的價值觀和生活方式。她強調簡單、自然和寧靜的生活，以及對傳統技藝和文化的尊重。她的影片給觀眾帶來了一種尋找平靜和與自然連接的感覺，也啟發了許多人重新思考現代都市生活的價值和意義。 '),
...
(22, 11250106, '王力宏', 'Leehom', '1995/05/17', 'F197605176', '紐約羅切斯特', '09197605178', 'theleehomman@gmail.com', '資訊工程', '李靚蕾', '王力宏（Leehom Wang），1976年5月17日出生於美國紐約，是一位知名的華人音樂家、歌手、詞曲創作人、音樂製作人、演員和導演。他以其多才多藝、跨界合作和音樂創新而聞名。<br />\r\n<br />\r\n王力宏以流行音樂為主，融合了中國傳統音樂、西方流行、爵士、饒舌和古典等不同音樂風格。他的音樂作品通常富有深度和情感，歌曲的主題範圍從愛情、社會議題到個人成長等廣泛涵蓋。<br />\r\n<br />\r\n他於1995年發行首張個人專輯《愛的就是你》開始了他的音樂生涯，並迅速贏得了廣大樂迷的喜愛。他的歌曲包括《心中的日月》、《唯一》、《依然愛你》、《你不知道的事》等，這些歌曲在華語流行音樂界取得了巨大的成功。<br />\r\n<br />\r\n除了音樂方面的成就，王力宏還參與了多部電影和電視劇的演出，並展現了優秀的演技。他也擔任過電影的導演和音樂製作人，並在多個領域中展現了他的才華和創造力。<br />\r\n<br />\r\n王力宏的音樂才華和全能表演使他成為華語流行音樂界的領軍人物之一。他的作品和音樂風格廣受讚譽，並獲得了多個音樂獎項和榮譽。他的表演風格和獨特個性使他贏得了廣大粉絲的喜愛和支持。'),
...
(31, 11250304, '呂布', 'boo', '1995/03/30', 'A123456789', '台北市希干希納區中興街835號', '0929312288', 'theallenman01@gmail.com', '化工材料', '張菲', NULL);
